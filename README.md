...
GitHub Pages on the free plan, and it also makes Actions minutes unlimited/free) — the
two API keys only ever exist as encrypted GitHub Actions secrets and a local, gitignored
`.env`; they were never committed.
